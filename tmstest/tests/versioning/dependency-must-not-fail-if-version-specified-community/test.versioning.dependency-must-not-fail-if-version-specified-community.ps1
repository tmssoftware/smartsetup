...
Test-ProductVersions -Products $products -ExpectedAVersion "v1.0.0" -ExpectedBVersion "v1.0.0" -ExpectedCVersion "v1.1.0"

$installResult = tms update tmstest.a:v1.1.0
$products = tms list -detailed -json | ConvertFrom-Json -AsHashtable
Test-ProductVersions -Products $products -ExpectedAVersion "v1.1.0" -ExpectedBVersion "v1.1.0" -ExpectedCVersion "v1.1.0"
...
Test-CommandFails { tms install tmstest.x:v1.0.0 } "*requires the product ""Spring4D"" to build, and it isn't present*"
