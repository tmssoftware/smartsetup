...
Update-TmsbuildYamlWithLocalUrl -TmsbuildFilePath ./.zips/tmsbuild.yaml -fileName "/evil_ok.tar.zst"
...
Copy-Item -Path "$PWD/.zips/tmsbuild-template.yaml" -Destination "$PWD/.zips/tmsbuild.yaml" -Force
Update-TmsbuildYamlWithLocalUrl -TmsbuildFilePath ./.zips/tmsbuild.yaml -fileName "/evil_ko.tar.zst"
